...
Pod::Spec.new do |s|
  s.name             = 'RxMatrixSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RxMatrixSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rezacute/RxMatrixSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rezacute' => 'riza.alaudin@kii.com' }
  s.source           = { :git => 'https://github.com/rezacute/RxMatrixSDK.git', :tag => s.version.to_s }
